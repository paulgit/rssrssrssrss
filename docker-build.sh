...
LABEL_ARGS=(
  ...
  --label "org.opencontainers.image.title=rssrssrssrss"
  --label "org.opencontainers.image.description=A simple, stateless SPA that allows users to combine multiple RSS feeds into a single RSS feed URL"
